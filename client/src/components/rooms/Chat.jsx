            ...
            <form onSubmit={submit} className={styles.writeMessage}>
                {
                    ...
                    : 
                    <input placeholder={'Enter to send messages...'} name="" id="" cols="31" rows="1" value={msg} onChange={event => setMsg(event.target.value)} className={styles.writeMessageGame}></input>
                }
