...
async function endGame(playerOne, playerTwo, common, roomId, io){
    if(playerOne.score >= common.scoreToWin || playerTwo.score >= common.scoreToWin){
        await axios.put(`https://trucohenry.com/api/games/${common.gameId}/${playerOne.score}/${playerTwo.score}`);
        if(playerOne.score >= common.scoreToWin){
            await axios.put(`https://trucohenry.com/api/games/losser/${common.gameId}/${playerOne.score}/${playerTwo.score}`,{},{
                headers: {
                    "x-access-token": playerTwo.token || 1,
                }})
            await axios.put(`https://trucohenry.com/api/games/winner/${common.gameId}/${playerOne.score}/${playerTwo.score}`,{},{
            headers: {
...
function quieroEnvido(playerOne, playerOneEnvido, isPlayerOne, playerTwo, playerTwoEnvido, common, roomId, score, bool, io){
...
function noQuieroFaltaEnvido(playerOne, playerTwo, isPlayerOne, common, noQuieroEnvido, io){
...
exports = module.exports = function(io){
    ...
    socket.on("bet", (betPick, roomId, playerId) => {
        ...
        if(betPick === "ir al mazo") {
            ...
            isPlayerOne? noQuieroFaltaEnvido(playerOne, playerTwo, isPlayerOne, common, noQuieroEnvido, io) : noQuieroFaltaEnvido(playerOne, playerTwo, isPlayerOne, common, noQuieroEnvido, io);
        ...
        axios.put(`https://trucohenry.com/api/games/${common.gameId}/${playerOne.score}/${playerTwo.score}`);
